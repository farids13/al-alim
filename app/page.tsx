...
export default function Home() {
  ...
  const aboutContent = {
   ...
   const portofolioSlides = [
    ...
    {
      image: "/images/porto-4.jpeg",
      title: "PROSES INTERVIEW",
      subtitle: "Dengan Berbagai Perusahaan",
    },
    {
      image: "/images/porto-5.jpeg",
      title: "PENGALAMAN KERJA PROFESIONAL",
      subtitle: "Membangun karir di berbagai bidang profesional",
    },
    {
      image: "/images/porto-6.jpeg",
      title: "PENGALAMAN KERJA PROFESIONAL",
      subtitle: "Membangun karir di berbagai bidang profesional",
    },
    {
      image: "/images/porto-7.jpeg",
      title: "PENGALAMAN KERJA PROFESIONAL",
      subtitle: "Membangun karir di berbagai bidang profesional",
    },
    {
      image: "/images/porto-8.jpeg",
      title: "PENGALAMAN KERJA PROFESIONAL",
      subtitle: "Membangun karir di berbagai bidang profesional",
    }, 
    {
      image: "/images/porto-9.jpeg",
      title: "PENGALAMAN KERJA PROFESIONAL",
      subtitle: "Membangun karir di berbagai bidang profesional",
    }
          ...
          <div className="pt-8 mt-8 border-t border-blue-700">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex space-x-6 mt-4 md:mt-0">
                <a href="https://www.facebook.com/profile.php?id=100005206994825&mibextid=ZbWKwL" className="text-blue-200 hover:text-white transition-colors duration-200">
                  <span className="sr-only">Facebook</span>
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" />
                  </svg>
                </a>
                <a href="https://www.instagram.com/alaliim9/profilecard/?igsh=dTQycnpxaDJ3dDZv" className="text-blue-200 hover:text-white transition-colors duration-200">
                ...
                <a href="https://youtube.com/@pondokmilenialal-aliim9848?si=DObIw8lscmwCdwf-" className="text-blue-200 hover:text-white transition-colors duration-200">
